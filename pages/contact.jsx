...
const contact = () => {
  ...
  let data={
    inner_banner_title: {
      title: " Contact Us",
      image:`${baseUrl}ContacUs anner.jpg`
    },
  }
  ...
  return (
    <>
      <Head>
        <title>Contact Us | Ethical Swag</title>
        <meta
          name="description"
          content="Use the form below to send your message. A member of our team will reach out to you within 1 business day. If you don't hear from us in this time frame, please check your spam box. Prefer to call? You can reach us at: :phone: 1-877-256-6998 :phone: 1-902-500-1086"
        />
